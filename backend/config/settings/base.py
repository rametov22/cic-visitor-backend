...
APP_NAME = config("DJANGO_APP_NAME", default="CIC Visitor")
SECRET_KEY = config(
    "DJANGO_SECRET_KEY",
...
DATABASES = {
    "default": {
        ...
        "NAME": config("POSTGRES_DB", default="iccu_db"),
        "USER": config("POSTGRES_USER", default="iccu_db_user"),
...
NEWS_API_URL = config("NEWS_API_URL", default="")
